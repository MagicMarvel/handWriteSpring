...
public class ResourceResolverTest {
    ...
    private final Logger logger = LoggerFactory.getLogger(ResourceResolverTest.class);

    @Test
    public void scanClass() throws URISyntaxException, IOException {
        var pkg = "com.magicmarvel";
    ...
    public void scanJar() throws URISyntaxException, IOException {
        ...
        // jakarta.annotation.jakarta.annotation.sub.AnnoScan is defined in classes:
