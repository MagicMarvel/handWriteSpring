...
public class ResourceResolver {
    ...
    public <T> List<T> scan(Function<Resource, T> mapper) throws URISyntaxException, IOException {
        ...
        // 如这个输入 magicmarvel.context 会返回
        // file:/G:/summer-framework/step-by-step/context/target/test-classes/magicmarvel/context
        // file:/G:/summer-framework/step-by-step/context/target/classes/magicmarvel/context
